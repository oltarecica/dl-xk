...
// ============================================================
// 1. VIIRS Nighttime Lights — 2023 annual median composite
...
Export.image.toDrive({
  image: viirs,
  description: 'viirs_nightlights_kosovo_2023',
  folder: 'dl-xk-data',
  fileNamePrefix: 'viirs_nightlights_kosovo_2023',
  region: kosovo,
  scale: 500,
  maxPixels: 1e9
});
...
// ============================================================
// 2. GHSL Built-Up Surface — 2020 epoch
//    Dataset: JRC Global Human Settlement Layer P2023A
//    Band:    built_surface (m² per 100m pixel) → divided by
//             10000 to give fraction [0, 1].
//    Exported at 500m: GEE aggregates 100m → 500m by mean,
//    giving the same pixel grid as the VIIRS export above.
// ============================================================
